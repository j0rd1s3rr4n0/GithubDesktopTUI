...
const translations = {
  en: {
    ...
    // Bottom Hints
    bottomHint: ' Click Tabs or press 1-8 | [?] Help | [F3] Lang: EN | [L] Auth | [S-q] Quit',
  ...
  es: {
    ...
    bottomHint: ' Clic en pestañas o pulsa 1-8 | [?] Ayuda | [F3] Idioma: ES | [L] Auth | [S-q] Salir',
  ...
  ca: {
    ...
    bottomHint: ' Clic a pestanyes o prem 1-8 | [?] Ajuda | [F3] Idioma: CA | [L] Auth | [S-q] Sortir',
  ...
  fr: {
    ...
    bottomHint: ' Cliquez onglets ou 1-8 | [?] Aide | [F3] Lang: FR | [L] Auth | [S-q] Quitter',
  ...
  de: {
    ...
    bottomHint: ' Klick Tabs oder 1-8 | [?] Hilfe | [F3] Spr: DE | [L] Auth | [S-q] Beenden',
  ...
  cs: {
    ...
    bottomHint: ' Klikněte na záložky nebo 1-8 | [?] Nápověda | [F3] Jazyk: CS | [L] Auth | [S-q] Ukončit',
  ...
  ru: {
    ...
    bottomHint: ' Кликните вкладки или 1-8 | [?] Справка | [F3] Яз: RU | [L] Auth | [S-q] Выход',
  ...
  zh: {
    ...
    headerUser: 'GitHub:',
    notLoggedIn: '未登录',
    bottomHint: ' 点击标签页或按 1-8 | [?] 帮助 | [F3] 语言: ZH | [L] 登录 | [S-q] 退出',
  ...
  ja: {
    ...
    headerUser: 'GitHub:',
    notLoggedIn: '未ログイン',
    bottomHint: ' タブをクリックまたは1-8 | [?] ヘルプ | [F3] 言語: JA | [L] 認証 | [S-q] 終了',
  ...
  hi: {
    ...
    bottomHint: ' टैब क्लिक करें या 1-8 दबाएं | [?] मदद | [F3] भाषा: HI | [L] लॉगिन | [S-q] बाहर',
