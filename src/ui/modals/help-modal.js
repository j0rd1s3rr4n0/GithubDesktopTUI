...
export class HelpModal {
  constructor(screen) {
    ...
    const helpContent = [
      ...
      '  {cyan-fg}m{/cyan-fg}            Marcar / desmarcar archivo para deshacer (undo)',
      '  {cyan-fg}D{/cyan-fg}            Descartar (revertir) todos los archivos marcados con ✗',
      '',
      ...
      '  {cyan-fg}p{/cyan-fg}            Git Pull (normal)',
      '  {cyan-fg}Shift+P{/cyan-fg}      Force Push (equiv. --force-with-lease)',
      '  {cyan-fg}Shift+O{/cyan-fg}      Force Pull (hard reset to remote)',
      '',
